...
interface TranscriptEditHeaderProps {
  transcript: TranscriptDetail | null;
  audioFile: AudioFileMetadata | null;
  formatDuration: (seconds: number) => string;
}

export function TranscriptEditHeader({
  transcript,
  audioFile,
  formatDuration,
}: TranscriptEditHeaderProps) {
      ...
      <div className="px-6 py-4">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <span className="shrink-0 text-[10px] font-black px-2 py-0.5 rounded-full border bg-red-50 text-red-600">
              Chỉnh sửa Bản Dịch
            </span>
          </div>
