...
interface TranscriptViewHeaderProps {
  transcript: TranscriptDetail | null;
  audioFile: AudioFileMetadata | null;
  formatDuration: (seconds: number) => string;
}

export function TranscriptViewHeader({
  transcript,
  audioFile,
  formatDuration,
}: TranscriptViewHeaderProps) {
      ...
      <div className="px-6 py-4">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <span className="shrink-0 text-[10px] font-black px-2 py-0.5 rounded-full border bg-green-50 text-green-600">
              Xem Bản Dịch
            </span>
          </div>
