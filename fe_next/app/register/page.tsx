    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-md bg-white border border-slate-100 rounded-3xl p-10 shadow-2xl shadow-slate-200/50">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-slate-800 mt-2">Tạo tài khoản mới</h1>
          <p className="text-sm text-slate-400 mt-1">Đăng ký thành viên quản trị hệ thống</p>
        </div>
        ...
        {success && (
          <div className="flex items-center gap-2 bg-green-50 border border-green-100 text-green-600 p-4 rounded-2xl text-sm mb-6">
            <CheckCircle size={18} className="shrink-0" />
            <span className="font-medium">Đăng ký thành công! Đang chuyển hướng...</span>
          </div>
        )}

        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2 pl-1">Họ và Tên</label>
