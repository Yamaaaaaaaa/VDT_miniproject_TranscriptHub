...
export const ScriptManagement: React.FC = () => {
  ...
  useEffect(() => {
    if (fileIdParam) {
      navigate(`/scripts/${fileIdParam}`, { replace: true });
    }
  }, [fileIdParam, navigate]);
  ...
  const handleSelectTranscript = (transcript: Transcript) => {
    ...
    navigate(`/scripts/${transcript.audioFileId}`);
  };
                  ...
                  <tr>
                    <td colSpan={6}>
                      <div className="table-empty">
                        ...
                        <Link to="/files" className="btn btn-primary" style={{ marginTop: '0.5rem' }}>
