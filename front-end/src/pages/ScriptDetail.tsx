...
export const ScriptDetail: React.FC = () => {
  ...
  const activeSegmentId = useMemo(() => {
    ...
    // Find segment where current time falls within startTime and endTime
  ...
  // Download transcript functions
  const downloadTxt = () => {
    if (!selectedTranscript || !associatedFile) return;
    
    // Create text content with speaker tags and timeline
  ...
  // Highlight search text within segments
            ...
            <div style={{ width: '340px', display: 'flex', flexDirection: 'column', gap: '1.25rem', flexShrink: 0 }}>
              ...
              <div className="card" style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                <div style={{ 
                  ...
                  {/* Play/Pause & volume controls row */}
